    ...
    <header>
      ...
      >
        ...
        <NavLink
          ...
          className={c(
            "flex items-center justify-center rd-5px h-40px hover:not-disabled:cursor-pointer transition-all duration-200 ease-linear disabled:pointer-events-none py-11px px-20px rd-10px",
